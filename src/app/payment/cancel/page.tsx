  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="glass rounded-3xl p-8 sm:p-12 text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-dark-900 dark:text-white mb-3 font-[family-name:var(--font-heading)]">Payment Cancelled</h1>
        <p className="text-dark-600 dark:text-dark-400 mb-8">Your payment was not completed. You have not been charged.</p>
