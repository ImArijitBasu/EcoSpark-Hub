          ...
          >
            <div className="glass rounded-3xl p-8 sm:p-10 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={loading || googleLoading} className="btn-primary w-full py-3.5 text-center flex items-center justify-center gap-2 mt-4 disabled:opacity-50 cursor-pointer text-base">
